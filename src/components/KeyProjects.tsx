...
const PROJECTS: (ProjectDetail & { github?: string; link?: string })[] = [
  {
    ...
    github: "https://github.com/AMoizKhan/Presentation_Prefex",
  },
  {
    ...
    github: "https://github.com/AMoizKhan/Chat_app",
  },
  {
    title: "Email Spam Detection",
    subtitle: "AI / ML Project",
    year: "2023",
    stack: "Python, Scikit-learn, NLP, Next.js",
    ...
    points: [
      ...
      "Next.js + Tailwind UI for real-time predictions.",
    ],
    github: "https://github.com/AMoizKhan/Email_spam",
  },
  {
    title: "TravelHub",
    subtitle: "AI-Powered Travel Booking Platform",
    year: "2024",
    stack: "Next.js, TypeScript, Tailwind CSS",
    image: "https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=800&h=500&fit=crop",
    points: [
      "Full-stack travel booking with user auth (JWT), destinations search & filter, and Stripe-like booking flow.",
      "Admin dashboard for packages and users; AI recommendations; toast notifications.",
    ],
    github: "https://github.com/AMoizKhan/Travel",
  },
];
